...
export async function actionSaveSetting(formData: FormData) {
  ...
  await prisma.setting.upsert({
    where:  { id: 1 },
    update: { closingDay, break1Threshold, break1Minutes, break2Threshold, break2Minutes },
    create: { id: 1, closingDay, break1Threshold, break1Minutes, break2Threshold, break2Minutes },
  })
